...
-(void)setTagsFrame:(IMJIETagFrame *)tagsFrame{
    ...
    for (NSInteger i=0; i<tagsFrame.tagsArray.count; i++) {
        ...
        tagsBtn.layer.cornerRadius = kCornerRadius;
        [tagsBtn setBackgroundColor:unselectBackgroundColor];
    ...
    for (id obj in self.subviews) {
        if ([obj isKindOfClass:[UIButton class]]) {
            ...
            if (btn.tag == index){
                ...
                [btn setBackgroundColor:_clickBackgroundColor];
                ...
                [btn setBackgroundColor:unselectBackgroundColor];
