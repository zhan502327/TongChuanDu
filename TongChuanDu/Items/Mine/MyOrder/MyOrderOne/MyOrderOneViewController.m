...
@interface MyOrderOneViewController ()<UITableViewDataSource, UITableViewDelegate>
{
    int _page;
}
...
@implementation MyOrderOneViewController
...
- (void)loadData{
    ...
    NSString *type = @"1";//订单状态 1待支付，2待发货,3待收货,0全部
