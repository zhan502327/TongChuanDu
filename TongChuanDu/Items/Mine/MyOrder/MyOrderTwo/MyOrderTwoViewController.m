...
@interface MyOrderTwoViewController ()<UITableViewDataSource, UITableViewDelegate>
{
    int _page;
}
...
@implementation MyOrderTwoViewController
...
- (void)loadData{
    ...
    NSString *type = @"2";//订单状态 1待支付，2待发货,3待收货,0全部
