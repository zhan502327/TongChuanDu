...
@interface MyOrderThreeViewController ()<UITableViewDataSource, UITableViewDelegate>
{
    int _page;
}
...
@implementation MyOrderThreeViewController
...
- (void)loadData{
    ...
    NSString *type = @"3";//订单状态 1待支付，2待发货,3待收货,0全部
